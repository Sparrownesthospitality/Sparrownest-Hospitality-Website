...
const Amenities = () => {
  ...
  const amenities = [
    ...
    { icon: <Coffee className="w-8 h-8" />, name: 'Dedicated Workspace', description: 'It is a set place for work or study, helping you stay focused and organized.' },
    ...
    { icon: <Wind className="w-8 h-8" />, name: 'Air Conditioning', description: 'Individual temperature control in each room' },
    { icon: <Dumbbell className="w-8 h-8" />, name: 'Private Living Room', description: 'A cozy and intimate space designed for relaxation and comfort.' },
    { icon: <SwimmingPool className="w-8 h-8" />, name: 'All Kitchen Utensils', description: 'Knives, spatulas, tongs, pots, pans, bowls.' },
